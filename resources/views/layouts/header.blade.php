...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/min.js/0.2.3/$.js" defer> </script>
...
<body>
    <div id="app">
        <nav class="navbar navbar-default navbar-expand-sm fixed-top" role="navigation">
            <div class="container">
                <a href="http://localhost:8000/home" class="logo_findapaw"><img src="../img/findapaw_identity_white.png"></a> 
                </a>
